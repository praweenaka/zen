...
<!-- Mirrored from zendomus.pt/demo.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 24 May 2020 05:31:26 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <!-- Stylesheets
    ============================================= -->
    <link href="http://fonts.googleapis.com/css?family=Lato:300,400,700|Arimo:400,700|Playfair+Display:400,400i,700|Cookie"
          rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" href="src/assets/css/bootstrap.css" type="text/css"/>
    <link rel="stylesheet" href="src/css/style.css" type="text/css"/>
    <link rel="stylesheet" href="src/assets/css/dark.css" type="text/css"/>

    <!-- spa Demo Specific Stylesheet -->
    <link rel="stylesheet" href="src/assets/demos/spa/spa.css" type="text/css"/>
    <link rel="stylesheet" href="src/assets/demos/spa/css/fonts/spa-icons.css" type="text/css"/>
    <!-- / -->

    <link rel="stylesheet" href="src/assets/css/font-icons.css" type="text/css"/>
    <link rel="stylesheet" href="src/assets/css/animate.css" type="text/css"/>
    <link rel="stylesheet" href="src/assets/css/magnific-popup.css" type="text/css"/>

    <link rel="stylesheet" href="src/assets/demos/spa/css/fonts.css" type="text/css"/>

    <link rel="stylesheet" href="src/assets/css/responsive.css" type="text/css"/>
    <meta name="viewport" content="width=device-width, initial-scale=1"/>

    <link rel="stylesheet" href="src/assets/css/colors4f38.css?color=004A3B" type="text/css"/>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css"
          integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">

    <!-- SLIDER REVOLUTION 5.x CSS SETTINGS -->
    <link rel="stylesheet" type="text/css" href="src/assets/include/rs-plugin/css/settings.css" media="screen"/>
    <link rel="stylesheet" type="text/css" href="src/assets/include/rs-plugin/css/layers.css">
    <link rel="stylesheet" type="text/css" href="src/assets/include/rs-plugin/css/navigation.css">

    <!-- Document Title
    ============================================= -->
    <title>Zen Dommus - Massagens ao Domicilio</title>
    ...
    <header id="header" class="no-sticky transparent-header dark" data-responsive-class="dark">
        ...
        <div id="header-wrap">
            ...
            <div class="container clearfix">
                ...
                ============================================= -->
                <div id="logo">
                    <a href="index1.html" class="standard-logo"><img src="src/assets/demos/spa/images/logo.png"
                                                                    alt="Canvas Logo"></a>
                    <a href="index1.html" class="retina-logo"><img src="src/assets/demos/spa/images/logo.png"
                                                                  alt="Canvas Logo"></a>
                </div><!-- #logo end -->
                ...
                <nav id="primary-menu" class="not-dark">
                    ...
                    <ul class="one-page-menu" data-easing="easeInOutExpo" data-speed="1250" data-offset="0">
                        <li class="current"><a href="#" data-href="#slider">
                                <div>Home</div>
                            </a></li>
                        <li><a href="#" data-href="#section-about">
                                <div>About</div>
                            </a></li>
                        <li><a href="#" data-href="#section-price">
                                <div>Price</div>
                            </a></li>
    ...
    <section id="slider" class="slider-element revslider-wrap full-screen clearix">
        ...
        <div id="rev_slider_10_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="fashion1"
            ...
            <div id="rev_slider_10_1" class="rev_slider" style="display:none;" data-version="5.0.7">
                <ul>
                    <!-- SLIDE  -->
                    <li data-index1="rs-36" class="dark" data-transition="fadetoleftfadefromright"
                        ...
                        <img src="src/assets/demos/spa/images/slider/1.jpg" style='background-color:#ffffff' alt=""
                        ...
                        <div class="tp-caption tp-shape tp-shapewrapper   tp-resizeme rs-parallaxlevel-0"
                             ...
                             style="z-index1: 5; background: rgba(0,0,0,0.2)">
                        </div>
                        ...
                        <div class="tp-caption -  "
                             ...
                             data-responsive="off"
                             style="z-index1: 5; white-space: nowrap; font-size: 20px; line-height: 22px; font-weight: 400;padding:3px 8px 3px 8px;border-style:solid;border-width:1px;border-radius:30px 30px 30px 30px;">
                        ...
                        <div class="tp-caption Fashion-BigDisplay   tp-resizeme"
                             ...
                             data-basealign="slide"
                             data-responsive_offset="on"
                             style="z-index1: 9; white-space: nowrap;">Spa Treatment
                        </div>
                        ...
                        <div class="tp-caption Fashion-TextBlock   tp-resizeme"
                             ...
                             data-basealign="slide"
                             data-responsive_offset="on"
                             style="z-index1: 10; min-width: 219px; max-width: 219px; max-width: 161px; max-width: 161px; white-space: normal;">
                        ...
                        <div class="tp-caption Fashion-SmallText   tp-resizeme"
                             ...
                             data-basealign="slide"
                             data-responsive_offset="on"
                             style="z-index1: 11; white-space: nowrap;">UNISEX
                        </div>
                        ...
                        <div class="tp-caption Fashion-TextBlock   tp-resizeme"
                             ...
                             data-basealign="slide"
                             data-responsive_offset="on"
                             style="z-index1: 12; min-width: 219px; max-width: 219px; max-width: 161px; max-width: 161px; white-space: normal; font-weight: 600;">
                            Body Scrub<br/>
                            Body Wrap<br/>
                            Thai Therapy
                            Baliness Massage<br/>
                    ...
                    <!-- SLIDE  -->
                    <li data-index1="rs-37" data-transition="fadetoleftfadefromright" data-fstransition="fade"
                        data-slotamount="7" data-easein="default" data-easeout="default" data-masterspeed="1500"
                        data-thumb="http://server.local/revslider/wp-content/uploads/" data-rotate="0"
                        data-saveperformance="off" data-title="Smart Look" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="src/assets/demos/spa/images/slider/2.jpg" style='background-color:#ffffff' alt=""
                             data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"
                             data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        ...
                        <div class="tp-caption -  "
                             ...
                             data-responsive_offset="off"
                             data-responsive="off"
                             style="z-index1: 7; white-space: nowrap; font-size: 20px; line-height: 22px; font-weight: 400; color: rgba(0, 0, 0, 1.00);padding:3px 8px 3px 8px;border-color:rgba(0, 0, 0, 1.00);border-style:solid;border-width:1px;border-radius:30px 30px 30px 30px;">
                            <i class="icon-angle-down"></i>
                        </div>
                        ...
                        <div class="tp-caption Fashion-BigDisplay   tp-resizeme"
                             ...
                             data-basealign="slide"
                             data-responsive_offset="on"
                             style="z-index1: 9; white-space: nowrap; color: #222;">Beauty Spa
                        </div>
                        ...
                        <div class="tp-caption Fashion-TextBlock   tp-resizeme"
                             ...
                             data-basealign="slide"
                             data-responsive_offset="on"
                             style="z-index1: 10; min-width: 219px; max-width: 219px; max-width: 161px; max-width: 161px; white-space: normal;color: #222;">
                            <i class="icon-line-check"></i><br>
                            <i class="icon-line-check"></i><br>
                            <i class="icon-line-check"></i><br>
                            <i class="icon-line-check"></i><br>
                        ...
                        <div class="tp-caption Fashion-SmallText   tp-resizeme"
                             ...
                             data-basealign="slide"
                             data-responsive_offset="on"
                             style="z-index1: 11; white-space: nowrap; color: rgba(0, 0, 0, 0.6);">WOMEN
                        </div>
                        ...
                        <div class="tp-caption Fashion-TextBlock   tp-resizeme"
                             ...
                             data-basealign="slide"
                             data-responsive_offset="on"
                             style="z-index1: 12; min-width: 219px; max-width: 219px; max-width: 161px; max-width: 161px; white-space: normal; font-weight: 400; color: #222;">
                            Manicure<br/>
                            Hair Cut<br/>
                            Head Wash<br/>
                            Fruit Bleach
                    ...
                    <!-- SLIDE  -->
                    <li data-index1="rs-38" class="dark" data-transition="slideoververtical" data-slotamount="7"
                        data-easein="default" data-easeout="default" data-masterspeed="1500" data-thumb=""
                        data-rotate="0" data-saveperformance="off" data-title="Slide" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="src/assets/demos/spa/images/videos/1.jpg" alt="" data-bgposition="center center"
                        ...
                        <div class="tp-caption -  "
                             ...
                             data-responsive_offset="off"
                             data-responsive="off"
                             style="z-index1: 5; white-space: nowrap; font-size: 20px; line-height: 22px; font-weight: 400; color: rgba(255, 255, 255, 1.00);">
                        ...
                        <div class="tp-caption -  "
                             ...
                             data-responsive_offset="off"
                             data-responsive="off"
                             style="z-index1: 7; white-space: nowrap; font-size: 20px; line-height: 22px; font-weight: 400; color: #FFF;padding:3px 8px 3px 8px;border-color:rgba(255,255,255, 1.00);border-style:solid;border-width:1px;border-radius:30px 30px 30px 30px;">
                            <i class="icon-angle-down"></i>
                        </div>
                        ...
                        <div class="tp-caption Fashion-BigDisplay   tp-resizeme"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             style="z-index1: 6; white-space: nowrap; line-height: 100px;">Video Background
                        </div>
                        ...
                        <div class="tp-caption Fashion-BigDisplay   tp-resizeme"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             style="z-index1: 7; white-space: nowrap; font-size: 16px;text-transform: uppercase; line-height: 22px; font-weight: 400; font-family: 'Lato';">
                            Visit Our Store
                        </div>
                        ...
                        <div class="tp-caption Fashion-TextBlock   tp-resizeme"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             style="z-index1: 8; white-space: nowrap;"><i class="icon-map-marker"
                                                                         style="color:rgba(255,255,255,0.35);"></i> Shop
                            Street 234, LA<br/>
                            ...
                            <i class="icon-clock" style="color:rgba(255,255,255,0.35);"></i> Monday - Saturday 07:30 -
                            22:30
                        </div>
                    </li>
                </ul>
    ...
    <section id="content">
        ...
        <div class="content-wrap notoppadding">
                ...
                <div class="container clearfix">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Distinctio, libero voluptas
                                iusto quo illum quam possimus provident, deserunt est minima quisquam amet magnam animi?
                                Enim adipisci facilis voluptas odit! Facilis rerum ipsam modi perspiciatis
                                exercitationem explicabo, tempore soluta culpa cupiditate!</p>
                        </div>
                        <div class="col-lg-6">
                            <img class="bottommargin-lg divcenter img-fluid"
                                 src="src/assets/demos/spa/images/others/1.png" alt="">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-4 bottommargin">
                            <div class="feature-box fbox-plain" data-animate="fadeIn" data-delay="1000">
                                ...
                                <p>Voluptatum distinctio laboriosam, excepturi delectus nam fugit obcaecati reiciendis
                                    neque iste!</p>
                            </div>
                        </div>
                        <div class="col-lg-4 bottommargin">
                            <div class="feature-box fbox-plain" data-animate="fadeIn" data-delay="1000">
                                ...
                                <h3>Hair Dressing</h3>
                                <p>Quis, tenetur. Nam explicabo modi pariatur, blanditiis distinctio sapiente fugiat
                                    accusantium.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 bottommargin">
                            <div class="feature-box fbox-plain" data-animate="fadeIn" data-delay="1000">
                                ...
                                <p>Veniam atque corporis commodi. Quidem odit, necessitatibus quo tenetur! Harum
                                    similique illo eligendi!</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="section nomargin clearfix"
                 style="background: #FFF url('src/assets/demos/spa/images/others/2.jpg') no-repeat top left;">
                ...
                <div class="container clearfix">
                    <div class="row">
                        <div class="col-lg-7 offset-lg-5">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ullam cupiditate, libero
                                pariatur aliquam vitae deserunt esse assumenda, tenetur veritatis, nihil consectetur
                                facilis!</p>

                            <div class="col_one_third center topmargin-sm">
                                <i class="spa-leaves i-plain i-large divcenter nobottommargin"
                                   style="color: #D2D2D2;"></i>
                                <div class="counter ls1 t600" style="color: #777; margin-top: 10px;"><span
                                            data-from="10" data-to="21" data-refresh-interval="50"
                                            data-speed="2000"></span></div>
                                <h5>Spa Branches</h5>
                            </div>

                            <div class="col_one_third center topmargin-sm">
                                <i class="spa-woman i-plain i-large divcenter nobottommargin"
                                   style="color: #D2D2D2;"></i>
                                <div class="counter ls1 t600" style="color: #777; margin-top: 10px;"><span
                            ...
                            <div class="col_one_third col_last center topmargin-sm">
                                <i class="spa-meditation i-plain i-large divcenter nobottommargin"
                                   style="color: #D2D2D2;"></i>
                                <div class="counter ls1 t600" style="color: #777; margin-top: 10px;"><span
                        ...
                        <div class="row">
                                ...
                                <div class="feature-box media-box">
                                    <div class="fbox-media" style="padding: 0 40px;">
                                        <a href="#"><img class="rounded-circle img-thumbnail"
                                                         src="src/assets/demos/spa/images/services/1.jpg"
                                                         alt="Why choose Us?"></a>
                                    </div>
                                    <div class="fbox-desc">
                                        <h3>Beauty.<span
                                                    class="subtitle cookie-font">Your Property in Good Hands.</span>
                                        </h3>
                            ...
                            <div class="col-md-4 bottommargin-sm center">
                                <div class="feature-box media-box">
                                    <div class="fbox-media" style="padding: 0 40px;">
                                        <a href="#"><img class="rounded-circle img-thumbnail"
                                                         src="src/assets/demos/spa/images/services/2.jpg"
                                                         alt="Effective Planning"></a>
                                    </div>
                                    <div class="fbox-desc">
                                        <h3>Spa.<span
                                                    class="subtitle cookie-font">Construction Process Organized.</span>
                                        </h3>
                                        <p>Porro repellat vero sapiente amet vitae quibusdam necessitatibus consectetur,
                                            labore totam. Accusamus perspiciatis asperiores labore esse.</p>
                                    </div>
                                    <a href="#" class="button button-rounded" style="margin: 20px 0 0 0;">Read More</a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 bottommargin-sm center">
                                <div class="feature-box media-box">
                                    <div class="fbox-media" style="padding: 0 40px;">
                                        <a href="#"><img class="rounded-circle img-thumbnail"
                                                         src="src/assets/demos/spa/images/services/3.jpg"
                                                         alt="Why choose Us?"></a>
                                    </div>
                                    <div class="fbox-desc">
                                        <h3>Relax.<span class="subtitle cookie-font">We have got you Covered.</span>
                                        </h3>
                                        <p>Quos, non, esse eligendi ab accusantium voluptatem. Maxime eligendi beatae,
                                            atque tempora ullam. Vitae delectus quia, consequuntur rerum quo.</p>
                                    </div>
                                    <a href="#" class="button button-rounded" style="margin: 20px 0 0 0;">Read More</a>
                                </div>
                            </div>
            ...
            <div id="section-price" class="section nomargin page-section nobg">
                <div class="container clearfix">
                            ...
                            <div class="tab-content clearfix" id="tabs-1">
                                <div class="row">
                                    <div class="col-lg-6 service-wrap">
                                        ...
                                        <p class="service-desc">Lorem ipsum dolor sit amet, consectetur adipisicing
                                            elit. Sunt quos harum officia eaque nobis ut.</p>
                                    </div>
                    ...
                    <div class="center"><img class="img-responsive" src="src/assets/demos/spa/images/others/bg-tab.jpg"
                                             alt=""></div>
                </div>
            </div>

            <section id="section-testimonials" class="section parallax nobottommargin page-section dark"
                     style="background-image: url('src/assets/demos/spa/images/others/bg-testimonials.jpg'); padding: 140px 0; background-size: cover"
                            ...
                            <div class="fslider restaurant-reviews" data-arrows="false" data-animation="slide">
                                <div class="flexslider">
                                    <div class="slider-wrap">
                                        <div class="slide">
                                            <p class="lead">"Globalization fairness non-partisan visionary, institutions
                                                Aga Khan resolve. Results public-private partnerships, international
                                                development elevate scalable."</p>
                                        ...
                                        <div class="slide">
                                            <p class="lead">"Medicine; experience in the field climate change achieve
                                                voice public-private partnerships process our ambitions.
                                                Sanitation."</p>
                                        ...
                                        <div class="slide">
                                            <p class="lead">"Healthcare forward-thinking public service, social
                                                innovation making progress. Arab Spring social analysis, equality
                                                treatment, diversification."</p>
            ...
            <section id="section-contact" class="section nomargin nobottompadding nobg page-section">
                <div class="row clearfix">
                    <div class="col-md-4 offset-md-1 col-10 col-offset-1">
                        <div class="form-widget">
                            <div class="form-result"></div>
                            <form class="nobottommargin" id="template-contactform" name="template-contactform"
                                  action="http://zendomus.pt/include/form.php" method="post">

                                <div class="form-process"></div>

                                <div class="col_full nobottommargin">
                                    <button class="button button-3d nomargin" type="button" id="btnClientOrder">Client Order</button>
                                </div>
                            </form>
                    ...
                    <div class="col-md-7">
                        <img class="topmargin" src="src/assets/demos/spa/images/others/3.jpg" alt="">
                    </div>
                </div>
            </section>
        </div>
            ...
            <div class="container clearfix">
                ...
                <div class="row">
                            ...
                            <div>
                                ...
                                <address class="nobottommargin">
                                    <div class="text-muted">
                                        <p class="nobottommargin">795 Folsom Ave, Suite 600<br>
                    ...
                    <div class="col-lg-6 tright">
                        ...
                        <div class="clear"></div>
                        2014 All Rights Reserved by Canvas Inc.
                    </div>
                </div>
...
<script src="src/assets/include/rs-plugin/js/jquery.themepunch.tools.min.js"></script>
<script src="src/assets/include/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>

<script src="src/assets/include/rs-plugin/js/extensions/revolution.extension.video.min.js"></script>
<script src="src/assets/include/rs-plugin/js/extensions/revolution.extension.slideanims.min.js"></script>
<script src="src/assets/include/rs-plugin/js/extensions/revolution.extension.actions.min.js"></script>
<script src="src/assets/include/rs-plugin/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script src="src/assets/include/rs-plugin/js/extensions/revolution.extension.navigation.min.js"></script>
...
<script>
    $('#btnClientOrder').click(function () {
        window.location='index1.php';
    });
</script>
</body>

<!-- Mirrored from zendomus.pt/demo.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 24 May 2020 05:32:53 GMT -->
</html>